	    		...
	    		<div class="col-md-6">
		    		...
		    		<div class="form-group">
		          	...
		          	<div class="form-group">
		          		...
		          		<?php echo form_input('isbn', set_value('isbn', $details['isbn']),'class="form-control" id="isbn" required="required"'); ?>
		          	</div>
		         
		          	<div class="form-group">
		              	<label class="control-label" for="book_title"><?= lang('edit_book_label'); ?></label>
						<?php echo form_input('book_title', set_value('book_title', $details['book_title']),'class="form-control" id="book_title" required="required"');?>
		          	</div>
		          	<div class="form-group">
